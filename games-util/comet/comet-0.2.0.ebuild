...
# Submodule deps.
COMMIT_PROTO="5b78acfdc781f230e802476c1134f010463d7a91"
...
SRC_URI="
	...
	https://github.com/Yepoleb/gog_protocols/archive/${COMMIT_PROTO}.tar.gz -> ${P}-proto.tar.gz
	${CARGO_CRATE_URIS}
"
...
src_unpack() {
	...
	file ${DISTDIR}/${P}-proto.tar.gz
	tar xf "${DISTDIR}/${P}-proto.tar.gz" --strip-components 1 || die
